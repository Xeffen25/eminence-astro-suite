---
title: ThemeColor
description: Astro component that renders theme color meta tags for browser UI theming. Manages a single universal color value and scheme-specific light and dark values.
head:
  - tag: title
