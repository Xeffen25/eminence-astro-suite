---
title: Charset
description: Documentation for Charset, focused on rendering the document character encoding meta tag. It handles explicit charset values and defaults to utf-8 when omitted.
head:
    - tag: title
