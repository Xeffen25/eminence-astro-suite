...
| `icons`                       | `WebManifestIconItem[]`                   | -       | No       | Icons to represent the app. If omitted and the icons feature is active, auto-populated from generated 192 and 512 icons.                              |
...
<Code code={ManifestSource} lang="ts" title="manifest.ts" />
