...
description: Documentation for the sitemap integration feature, focused on delegating sitemap generation to @astrojs/sitemap. It requires the peer package to be installed and supports all upstream options.
---
