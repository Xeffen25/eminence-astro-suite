...
When no props are provided, the component falls back to the virtual module's `robots` config. This allows site-wide crawler settings to be configured once in the integration and overridden per page.
