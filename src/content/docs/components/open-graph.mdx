---
title: OpenGraph
description: Documentation for OpenGraph, focused on rendering Open Graph metadata tags for social sharing. It handles og:type inference, media metadata, locale tags, and typed OG namespace outputs.
head:
    - tag: title
...
<OpenGraph
	...
	image={{ src: "https://example.com/og.png", width: 1200, height: 630, alt: "Banner" }}
	article={{
